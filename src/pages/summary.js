...
const opt = [{value: 0, content: "Basic"},{value: 1, content: "Premium"}, {value: 2, content: "Master"}]
                ...
                <div style={{padding: "30px", display: "flex", justifyContent: "center"}}>
                    <div
                     style = {{
                        ...
                        <Card heading = {<div style = {{display: "flex", flexDirection: "row", flexWrap: "wrap"}}><div style = {{width: "50%"}}>Product</div>  <div style = {{width: "8rem"}}>Quantity</div> <div style = {{width: "8rem"}}>Item Price</div> <div style = {{textAlign: "right", width: "8rem"}}>Action</div></div>}>
                            <div style={{display: "flex", flexDirection: "row", flexWrap: "wrap"}}>
                                <div style={{display: "flex", padding: "10px", width: "50%"}}>
                                    ...
                                    <div style = {{padding: "10px"}}><DropDown dropDownWidth={"230px"} onChange = {() => null} active = {0} options ={opt}/> <br/>
                                    {this.state.name}
                                    </div>
...
{/* quantity increaser and decreaser will use state to change value */}
                                    <card  style = {{boxShadow: "0 0px 2px grey", borderRadius: "3px", width: "6rem", height: "2rem", top: "3rem", display: "flex"}}>
                                        <span style = {{width: "2rem", borderRightStyle: "solid", borderRightWidth: "1px",  borderRightColor: "#e6e6e6"}}><Icon type = {"feather"} name = "minus" /></span>
                                        <span style = {{width: "2rem", borderRightStyle: "solid", borderRightWidth: "1px",  borderRightColor: "#e6e6e6"}}>
                                        {this.state.productQuantity}
                                        </span>
                                        <span ><Icon type = {"feather"} name = "plus" /></span>
                                    </card> 
                                </div>
                                <div style = {{textAlign: "left", paddingTop: "3rem", paddingLeft: "1rem", fontWeight: "bold", fontSize: "1rem", width: "6rem"}}>    
                                    ₦ {this.state.price} <br/>
                                    <span style = {{color: "#bbb", fontWeight: "normal", fontSize: ".7rem"}}>₦ {this.state.price} x {this.state.productQuantity}</span>
                                </div>
                                <div style = {{textAlign: "right", paddingTop: "3rem", paddingLeft: "1rem", width: "8rem"}}>
                                    Remove Item
                                </div>
                            </div>
                        </Card>
